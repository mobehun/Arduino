...
void dateWrite(){
	...
	switch((int)ido.month()){
		case 1:{
			if(time>=640 && time<700) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1600 && time<1640) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 2:{
			if(time>=600 && time<630) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1700 && time<1730) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 3:{
			if(time>=515 && time<545) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1740 && time<1810) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 4:{
			if(time>=510 && time<545) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1920 && time<1955) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 5:{
			if(time>=415 && time<455) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=2005 && time<2045) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 6:{
			if(time>=355 && time<435) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=2030 && time<2115) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 7:{
			if(time>=415 && time<455) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=2025 && time<2100) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 8:{
			if(time>=455 && time<530) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1945 && time<2015) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 9:{
			if(time>=540 && time<615) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1845 && time<1915) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 10:{
			if(time>=620 && time<655) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1745 && time<1815) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 11:{
			if(time>=605 && time<640) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1555 && time<1630) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
		...
		case 12:{
			if(time>=640 && time<715) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
			if(time>=1540 && time<1615) {tft.drawBitmap(0, 0, sunLow, 48, 36, 0xFFFF); break; }
...
void tempWrite(){
	...
	while(!((sensors.getTempCByIndex(0)>-30 && sensors.getTempCByIndex(0)<50) || 
		    (sensors.getTempCByIndex(1)>-30 && sensors.getTempCByIndex(1)<50) || 
		    (sensors.getTempCByIndex(2)>-30 && sensors.getTempCByIndex(2)<50)));
